...
public interface EndPoint extends Closeable
{
     ...
     * a {@link #fill(java.nio.ByteBuffer)}.   Once the input is shutdown, all calls to
     * {@link #fill(java.nio.ByteBuffer)} will  return -1, until such time as the
    ...
    /**
     * <p>Requests callback methods to be invoked when a call to {@link #fill(java.nio.ByteBuffer)} would return data or EOF.</p>
     *
     * @param callback the callback to call when an error occurs or we are readable.
     * @throws java.nio.channels.ReadPendingException if another read operation is concurrent.
     */
    void fillInterested(Callback callback) throws ReadPendingException;

    /**
     * <p>Writes the given buffers via {@link #flush(java.nio.ByteBuffer...)} and invokes callback methods when either
     ...
     * @param buffers one or more {@link java.nio.ByteBuffer}s that will be flushed.
     * @throws java.nio.channels.WritePendingException if another write operation is concurrent.
     */
