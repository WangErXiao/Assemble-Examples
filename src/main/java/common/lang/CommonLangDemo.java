...
public class CommonLangDemo {
    ...
    public static void serializationUtilsDemo()
    {
        ...
        try
        {
            fos = new FileOutputStream(new File("/home/yao/tmp/test.txt"));
            fis = new FileInputStream(new File("/home/yao/tmp/test.txt"));
    ...
    public static void dateFormatUtilsDemo()
    {
    ...
    public static void main(String[]args){
        CommonLangDemo.CharSetDemo();
        CommonLangDemo.charSetUtilsDemo();
        CommonLangDemo.dateFormatUtilsDemo();
        CommonLangDemo.randomStringUtilsDemo();
        CommonLangDemo.genHeader("11");
    }
}
