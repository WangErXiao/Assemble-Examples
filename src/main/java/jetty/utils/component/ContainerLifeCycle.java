...
package jetty.utils.component;

import jetty.utils.annotation.ManagedObject;
import jetty.utils.annotation.ManagedOperation;
...
public class ContainerLifeCycle extends AbstractLifeCycle implements Container, org.eclipse.jetty.util.component.Destroyable, Dumpable
{
    ...
    public void destroy()
    {
        ...
        for (Bean b : reverse)
        {
            if (b._bean instanceof org.eclipse.jetty.util.component.Destroyable && (b._managed== Managed.MANAGED || b._managed== Managed.POJO))
            {
     ...
     * If the bean is a {@link org.eclipse.jetty.util.component.LifeCycle}, then it will be managed if it is not
