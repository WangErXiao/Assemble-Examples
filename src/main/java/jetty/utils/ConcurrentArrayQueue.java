...
/**
 * A concurrent, unbounded implementation of {@link java.util.Queue} that uses singly-linked array blocks
 * to store elements.
 * <p/>
 * This class is a drop-in replacement for {@link java.util.concurrent.ConcurrentLinkedQueue}, with similar performance
